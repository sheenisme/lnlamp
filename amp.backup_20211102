...
//     // isl_size dims = isl_constraint_dim(con_1, isl_dim_set);
//     // for (isl_size i = 0; i < dims; i++)
//     // {
//     //     isl_constraint_dump(con_1);
//     //     printf("cons dim(%d)'s name is %s.\t\n is lower bound? - %d .\t is upper bound? - %d. \t\n involves dims(%d,%d) - %d. \n", i, isl_constraint_get_dim_name(con_1, isl_dim_set, i),
//     //            isl_constraint_is_lower_bound(con_1, isl_dim_set, i), isl_constraint_is_upper_bound(con_1, isl_dim_set, i),
//     //            i, i + 1, isl_constraint_involves_dims(con_1, isl_dim_set, i, i + 1));
//     // }
...
//     isl_size dims = isl_constraint_dim(con_2, isl_dim_set);
//     for (isl_size i = 0; i < dims; i++)
//     {
//         isl_constraint_dump(con_2);
//         printf("cons dim(%d)'s name is %s.\t\n is lower bound? - %d .\t is upper bound? - %d. \t\n involves dims(% d, % d) - % d and involves dims(% d, % d) - % d \n ",
//                i, isl_constraint_get_dim_name(con_2, isl_dim_set, i), isl_constraint_is_lower_bound(con_2, isl_dim_set, i),
//                isl_constraint_is_upper_bound(con_2, isl_dim_set, i),
//                i, 1, isl_constraint_involves_dims(con_2, isl_dim_set, i, 1), i,
//                dims - i, isl_constraint_involves_dims(con_2, isl_dim_set, i, dims - i));
//         printf("coefficient val(%d) is : \n", i);
//         isl_val_dump(isl_constraint_get_coefficient_val(con_2, isl_dim_set, i));
//         printf("\nbound(%d) is :\n", i);
//         isl_aff *af = isl_constraint_get_bound(con_2, isl_dim_set, i);
//         isl_aff_dump(isl_aff_copy(af));
//         // isl_space *isl_space_1 = isl_aff_get_space(isl_aff_copy(af));
//         // int space_dim = isl_space_dim(isl_space_1, isl_dim_set);
//         // for (int j = 0; j < space_dim; j++)
//         //     printf("space dim %d name is %s \t", j, isl_space_get_dim_name(isl_space_1, isl_dim_set, j));
//         // printf("\n");
//         // // isl_aff_dump(af);
//         // printf("%s \n\n", isl_aff_to_str(af));
//         // int bound_dim = isl_aff_dim(isl_aff_copy(af), isl_dim_set);

//         // isl_aff_dump(isl_aff_from_range(af));
//         // // for (int j = 0; j < bound_dim; j++)
//         // // printf("involed %d dims ?%d\t", j, isl_pw_aff_get_tuple_id(af, isl_dim_set));
//         // printf("\n");

//         // isl_space_dump(isl_aff_get_space(af));
//         int bound_dim = isl_aff_dim(isl_aff_copy(af), isl_dim_set);
//         // printf("bound dim is %d ,%d \n", bound_dim, isl_aff_find_dim_by_name(isl_aff_copy(af), isl_dim_set, "i"));
//         for (int j = 0; j < bound_dim; j++)
//             printf("dim name %s, involves ? %d\t", isl_aff_get_dim_name(isl_aff_copy(af), isl_dim_set, j), isl_aff_involves_dims(isl_aff_copy(af), isl_dim_set, j, 1));
//         printf("\n");
//         // printf("bound dims is %d, involes res is: %d,  the name is: %s .\n", bound_dim, isl_aff_involves_dims(af, isl_dim_set, 0, dims), isl_aff_get_dim_name(af, isl_dim_set, bound_dim - 1));
//         // isl_val_dump(isl_aff_get_coefficient_val(af, isl_dim_set, 0));
//         // isl_val_dump(isl_aff_get_coefficient_val(af, isl_dim_set, 1));
//         // isl_val_dump(isl_aff_get_constant_val(isl_aff_copy(af)));
//         // printf("\nconstant val is :\n");
//         // isl_val_dump(isl_constraint_get_constant_val(con_2));
//         // printf("\n");
//     }
...
//     printf("\n");
// #endif // DEBUG_CHECK
//        // printf("param: %d in: %d out: %d set: %d \n", isl_constraint_dim(con_1, isl_dim_param), isl_constraint_dim(con_1, isl_dim_in), isl_constraint_dim(con_1, isl_dim_out), isl_constraint_dim(con_1, isl_dim_set));
//        // printf("param: %d in: %d out: %d set: %d \n", isl_constraint_dim(con_2, isl_dim_param), isl_constraint_dim(con_2, isl_dim_in), isl_constraint_dim(con_2, isl_dim_out), isl_constraint_dim(con_2, isl_dim_set));
//        // printf("param: %d in: %d out: %d set: %d \n", isl_constraint_dim(con_2_2, isl_dim_param), isl_constraint_dim(con_2_2, isl_dim_in), isl_constraint_dim(con_2_2, isl_dim_out), isl_constraint_dim(con_2_2, isl_dim_set));
//        // printf("%s \n", isl_constraint_get_dim_name(con_1, isl_dim_set, 0));
//        // printf("%s \n", isl_constraint_get_dim_name(con_1, isl_dim_set, 1));
//        // printf("%s \n", isl_constraint_get_dim_name(con_1, isl_dim_set, 2));
//        // isl_space *isl_space_1 = isl_constraint_get_space(con_1);
//        // isl_space *isl_space_2 = isl_constraint_get_space(con_2);

//     // isl_space_dump(isl_space_1);
//     // isl_space_dump(isl_space_2);
//     // printf("constraint space has equal params ?  res is :%d \n", isl_space_has_equal_tuples(isl_space_1, isl_space_2));
...
//     isl_space *isl_space_1 = isl_aff_get_space(aff_1);
//     isl_space *isl_space_2 = isl_aff_get_space(aff_2_2);
...
//     isl_space_dump(isl_space_1);
//     isl_space_dump(isl_space_2);
//     isl_id_dump(isl_space_get_domain_tuple_id(isl_space_1));
//     isl_id_dump(isl_space_get_domain_tuple_id(isl_space_2));

//     // isl_id_dump(isl_space_get_range_tuple_id(isl_space_1));
//     // isl_id_dump(isl_space_get_range_tuple_id(isl_space_2));
//     printf("%s \n", isl_space_get_dim_name(isl_space_1, isl_dim_in, 0));
//     printf("%s \n", isl_space_get_dim_name(isl_space_2, isl_dim_in, 1));
//     printf("aff space has equal params ?  res is :%d \n", isl_space_has_equal_params(isl_space_1, isl_space_2));
 ...
 * 检查循环索引之间的依赖关系
 */
static isl_stat split_on_bound_pair_check(__isl_take isl_constraint *lower,
                                          __isl_take isl_constraint *upper, __isl_take isl_basic_set *bset,
                                          void *user)
{
#define DEBUG_SPLIT_ON_BOUND_PAIR_CHECK
    struct split_date *data = (struct split_date *)user;
    isl_size nvar;

    nvar = isl_basic_set_dim(bset, isl_dim_set);
#ifdef DEBUG_SPLIT_ON_BOUND_PAIR_CHECK
    printf("current_dim is : %d\n", data->current_dim);
    printf("lower constraint and upper constraint is :\n");
    isl_constraint_dump(lower);
    isl_constraint_dump(upper);
    printf("\n");
    printf("isl_basic_set(Remove the current dimension) is :");
    isl_basic_set_dump(bset);
    printf("\n n var of isl_basic_set is : %d \n", nvar);
    ...
    for (isl_size i = 0; i < data->current_dim; i++)
    {
        ...
        {
#ifdef DEBUG_SPLIT_ON_BOUND_PAIR_CHECK
            printf("The lower bound of %d dimension depends on the %d dimension .\n", data->current_dim, i);
#endif // DEBUG_SPLIT_ON_BOUND_PAIR_CHECK
        ...
        {
#ifdef DEBUG_SPLIT_ON_BOUND_PAIR_CHECK
            printf("The upper bound of %d dimension depends on the %d dimension .\n", data->current_dim, i);
#endif // DEBUG_SPLIT_ON_BOUND_PAIR_CHECK
...
#ifdef DEBUG_SPLIT_ON_BOUND_PAIR_CHECK
    // 打印出来数组。
    printf("the loop index constraint array is:\n");
...
__isl_give struct amp_basic_set *amp_get_single_statement_constraints(__isl_keep isl_ctx *ctx, __isl_take isl_basic_set *basic_set, int deepth, int rate)
{
     ...
     */
    // printf("After init, the loop index constraint array is:\n");
    ...
    // 申请
    struct split_date *split_date = isl_alloc_array(ctx, struct split_date, 1);
    split_date->constraint_array = loop_index_constraint_relation_array;
    split_date->dims = bset_dims;

    for (isl_size i = 1; i < bset_dims; i++)
    {
        split_date->current_dim = i;
        isl_basic_set_foreach_bound_pair(basic_set, isl_dim_set, i, &split_on_bound_pair_check, split_date);
